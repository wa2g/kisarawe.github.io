...
if(isset($_POST['submit'])){
  ...
  $check=mysqli_query($con,"SELECT * from viwanja WHERE plot_no='$plot_no'");
 ...
 if($checkrows>0) {
  array_push($error, "Plot Number already exists");
                   ...
                   $result=mysqli_query($con,"INSERT INTO viwanja (plot_no,plot_size,wananchiid) VALUES ('$plot_no','$plot_size','$wananchiid')");
                    ...
                    echo mysqli_error($con);
                    header("location:viewmore.php?id=$wananchiid");
                    ;
...
<div class="modal-body col-md-4">
        ...
        <?php if(!empty($error)){
            ...
            <!-- <input type="text" name="plota" class="form-control mb-2" placeholder="Plot Attained" value="<?php if(isset($plota)){echo $plota;}?>">  -->
             ...
             <input type="submit" name="submit" value="Save Plot Details" class="btn btn-primary">
        </form>

      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"> Kisarawe District Council</h1>
...
<a href="kdc_info.php"><button type="button" class="btn btn-light mb-3" ><i class="fa fa-registered"> Register KDC plots </i></button></a>


    <a href="pdfkdc.php?plot_no=plot_no" class="btn btn-light mb-3" style="margin-left:66%"><i class="fa fa-file-pdf"> Download</i></a>
    <?php 
                $result = mysqli_query($con, "SELECT * FROM wmc WHERE owner= 'KDC'");
    ...
    while($row = mysqli_fetch_assoc($result)){ ?>
      ...
      <td><a style="border-radius:24px;" href="edit_plotkdc.php?plot_no=<?php echo $row['plot_no'];?> "class="btn btn-sm btn-light"><i class="fa fa-edit"></i></a>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
       ...
       <a style="border-radius:24px;" href="delete/deletekdc.php?plot_no=<?php echo $row['plot_no'];?>"class="btn btn-sm btn-danger"> Delete</a>
...
<?php }
      ...
      <!-- <td><?php echo $id ?></td> -->
<td><a style="border-radius:24px;" href="edit_plotkdc.php?plot_no=<?php echo $plot_no ?> "class="btn btn-sm btn-light"><i class="fa fa-edit"></i></a>
        <a style="border-radius:24px;" href="delete/deletekdc.php?plot_no=<?php echo $plot_no ?>"class="btn btn-sm btn-light"><i class="fa fa-trash"></i></a></td>
      <?php } else{
